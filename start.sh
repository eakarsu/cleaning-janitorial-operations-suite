...
PORT="${PORT:-5450}"
DB_NAME="${PGDATABASE:-cleaning_janitorial_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Cleaning Janitorial Operations Suite"
echo "======================================="
echo
...
echo "Starting cleaning janitorial operations suite frontend on http://localhost:$PORT"
echo "Login: admin@cleaning-janitorial-operations.local / admin123"
