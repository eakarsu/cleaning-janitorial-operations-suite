export const AUTH_COOKIE = 'cleaning_janitorial_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@cleaning-janitorial-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@cleaning-janitorial-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@cleaning-janitorial-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
